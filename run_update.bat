...
set "PLOCAL=%LocalAppData%"

if defined PF64 if exist "%PF64%\PowerShell\7\pwsh.exe" set "PS7_EXE=%PF64%\PowerShell\7\pwsh.exe"
if not defined PS7_EXE if defined PFW6432 if exist "%PFW6432%\PowerShell\7\pwsh.exe" set "PS7_EXE=%PFW6432%\PowerShell\7\pwsh.exe"
if not defined PS7_EXE if defined PF86 if exist "%PF86%\PowerShell\7\pwsh.exe" set "PS7_EXE=%PF86%\PowerShell\7\pwsh.exe"
if not defined PS7_EXE if defined PLOCAL if exist "%PLOCAL%\Programs\PowerShell\7\pwsh.exe" set "PS7_EXE=%PLOCAL%\Programs\PowerShell\7\pwsh.exe"
